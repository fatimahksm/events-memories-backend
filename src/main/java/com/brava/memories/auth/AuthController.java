...
public class AuthController {
    ...
    public AuthController(AuthService service, AppProperties props) {
    ...
    public AuthDtos.MeResponse register(
        ...
        return authenticate(service.register(req), response);
    }
    ...
    public void changePassword(
        ...
        service.changePassword(jwt.getSubject(), req);
    }

    private AuthDtos.MeResponse authenticate(
