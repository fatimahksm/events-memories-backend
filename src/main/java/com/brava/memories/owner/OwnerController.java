...
public class OwnerController {
 ...
 @DeleteMapping("/events/{eventId}/media/{mediaId}") @ResponseStatus(org.springframework.http.HttpStatus.NO_CONTENT) public void delete(@PathVariable UUID eventId,@PathVariable UUID mediaId,@AuthenticationPrincipal Jwt jwt){media.delete(eventId,mediaId,jwt.getSubject(),admin(jwt));}
