...
public class Event {
    ...
    public Event(UUID id, AppUser owner, String slug, String names, String quote, String namesAr, String quoteAr, LocalDate eventDate, Instant expiresAt, Instant mediaDeleteAt) {
        ...
        this.active=true; this.retentionStatus=EventRetentionStatus.ACTIVE; this.deletionAttempts=0; this.templateKey="elegant"; this.primaryColor="#FFFFFF"; this.accentColor="#C8A96B"; this.textColor="#FFFFFF"; this.overlayOpacity=.42; this.fontFamily="Georgia, var(--font-amiri), serif"; this.buttonRadiusPx=999; this.colorMode=EventColorMode.DARK; this.backgroundPositionX=50; this.backgroundPositionY=50; this.backgroundFit=BackgroundFit.COVER; this.createdAt=Instant.now(); this.updatedAt=createdAt;
    }
    ...
    public void extendAccess(Instant newExpiresAt,Instant newDeleteAt){this.expiresAt=newExpiresAt;this.mediaDeleteAt=newDeleteAt;if(retentionStatus!=EventRetentionStatus.ARCHIVED){this.retentionStatus=EventRetentionStatus.ACTIVE;this.lastDeletionError=null;}touch();}
