...
public class Event {
    ...
    public Event(UUID id, AppUser owner, String slug, String names, String quote, String namesAr, String quoteAr, LocalDate eventDate, Instant expiresAt, Instant mediaDeleteAt) {
        ...
        this.active=true; this.retentionStatus=EventRetentionStatus.ACTIVE; this.deletionAttempts=0; this.templateKey="elegant"; this.primaryColor="#FFFFFF"; this.accentColor="#C8A96B"; this.textColor="#FFFFFF"; this.overlayOpacity=.42; this.fontFamily="Georgia, serif"; this.buttonRadiusPx=999; this.createdAt=Instant.now(); this.updatedAt=createdAt;
    }
