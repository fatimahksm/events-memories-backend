...
public class EventService {
 ...
 @Transactional public Event createWithTheme(EventDtos.Create req,EventDtos.UpdateTheme theme){Event event=create(req);event.updateTheme(theme.templateKey(),theme.backgroundImageUrl(),theme.primaryColor(),theme.accentColor(),theme.textColor(),theme.overlayOpacity(),theme.fontFamily(),theme.buttonRadiusPx());return event;}
 ...
 @Transactional public Event updateTheme(Event e,EventDtos.UpdateTheme req){e.updateTheme(req.templateKey(),req.backgroundImageUrl(),req.primaryColor(),req.accentColor(),req.textColor(),req.overlayOpacity(),req.fontFamily(),req.buttonRadiusPx());return events.save(e);}
