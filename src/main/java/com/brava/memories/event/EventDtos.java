...
public final class EventDtos {
 private EventDtos(){}
 public record Theme(String templateKey,String backgroundImageUrl,String primaryColor,String accentColor,String textColor,double overlayOpacity,String fontFamily,int buttonRadiusPx){}
 ...
 public record Summary(UUID id,String slug,String names,String quote,String namesAr,String quoteAr,LocalDate eventDate,Instant expiresAt,Instant mediaDeleteAt,boolean active,EventRetentionStatus retentionStatus,int deletionAttempts,Theme theme){}
 public static Theme theme(Event e){return new Theme(e.getTemplateKey(),e.getBackgroundImageUrl(),e.getPrimaryColor(),e.getAccentColor(),e.getTextColor(),e.getOverlayOpacity(),e.getFontFamily(),e.getButtonRadiusPx());}
 public static Summary summary(Event e){return new Summary(e.getId(),e.getSlug(),e.getNames(),e.getQuote(),e.getNamesAr(),e.getQuoteAr(),e.getEventDate(),e.getExpiresAt(),e.getMediaDeleteAt(),e.isActive(),e.getRetentionStatus(),e.getDeletionAttempts(),theme(e));}
}
